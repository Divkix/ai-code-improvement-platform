...
<svelte:head>
    ...
    <meta name="description" content="Search through your code repositories to find functions, classes, and implementations quickly." />
</svelte:head>
        ...
        <div class="search-tips">
            ...
            <div class="tips-grid">
                <div class="tip-card">
                    ...
                    <p>Search for specific functions like <code>getUserData</code> or <code>calculateTotal</code></p>
                </div>
                <div class="tip-card">
                    <h4>🏗️ Class Names</h4>
                    <p>Find classes with names like <code>UserService</code> or <code>DatabaseConnection</code></p>
                </div>
                <div class="tip-card">
                    <h4>📝 Code Patterns</h4>
