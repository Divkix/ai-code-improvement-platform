...
<div class="search-filters">
    ...
    <div class="filters-grid">
        ...
        <div class="filter-group">
            <label for="language-filter" class="filter-label">
        ...
        <!-- File Type Filter -->
        <div class="filter-group">
            <label for="filetype-filter" class="filter-label">
                File Type
            </label>
            <div class="select-wrapper">
                <select 
        ...
        {#if repositories.length > 0}
            <div class="filter-group">
                <label for="repository-filter" class="filter-label">
                    Repository
                </label>
                <div class="select-wrapper">
                    <select 
            ...
            <div class="active-filter-tags">
                {#if selectedLanguage}
                    <span class="filter-tag">
                        ...
                        <button 
                            class="remove-filter" 
                            on:click={() => {selectedLanguage = ''; dispatch('languageChange', '');}}
                ...
                {#if selectedFileType}
                    <span class="filter-tag">
                        ...
                        <button 
                            class="remove-filter" 
                            on:click={() => {selectedFileType = ''; dispatch('fileTypeChange', '');}}
                ...
                {#if selectedRepository}
                    ...
                    <span class="filter-tag">
                        ...
                        <button 
                            class="remove-filter" 
                            on:click={() => {selectedRepository = ''; dispatch('repositoryChange', '');}}
